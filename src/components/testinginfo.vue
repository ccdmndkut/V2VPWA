  ...
  >
    <v-card>
      <v-toolbar tabs dark color="vueblue">
        ...
        <v-toolbar-title class="headline titlefix">{{
          myinfo.name
        }}</v-toolbar-title>
        <v-spacer></v-spacer>
              ...
              <v-card color="white" width="50vw" height="410">
                <v-card flat>
                  ...
                  <v-toolbar height="45" dark dense color="vuegreendark">
                    <v-toolbar-title>
                      <v-icon>home</v-icon>
                      <span class="ml-2"> {{ sectionOne.title }}</span>
                    </v-toolbar-title>
                    <v-spacer></v-spacer>
                    <v-icon
                  ...
                  <template v-if="edit == true">
                    ...
                    <v-layout class="ml-4 pt-0 mt-0" row wrap>
                      <v-flex xs3 class="mr-3">
                        <v-text-field
                          v-model="clientObj.clientInfo.city"
                          label="City"
                          :placeholder="this.db.clientInfo.city"
                          type="text"
                          class="pt-0 mt-0"
                          single-line
                        ></v-text-field>
                      ...
                      <v-flex xs1 class="mr-3 pt-0 mt-0">
                        <v-text-field
                          v-model="clientObj.clientInfo.state"
                          label="State"
                          :placeholder="this.db.clientInfo.state"
                          type="text"
                          class="pt-0 mt-0"
                          single-line
                        ></v-text-field>
                      ...
                      <v-flex xs2>
                        <v-text-field
                          v-model="clientObj.clientInfo.zip"
                          label="Zip"
                          :placeholder="this.db.clientInfo.zip"
                          type="text"
                          class="pt-0 mt-0"
                          single-line
                        ></v-text-field>
                    ...
                    <v-list class="mt-3 mb-3" three-line subheader>
                      <v-list-tile>
                        <v-list-tile-content class="title">
                          ...
                          >
                          <v-list-tile-title class="ml-4">{{
                            this.db.clientInfo.street
                          }}</v-list-tile-title>
                          <v-list-tile-title class="ml-4">
                            <div>
                              {{ this.db.clientInfo.city }},
                              {{ this.db.clientInfo.state }}
                              {{ this.db.clientInfo.zip }}
                            </div>
                          </v-list-tile-title>
                        </v-list-tile-content>
                      </v-list-tile>
                  ...
                  <template v-if="editContact == true">
                    <v-layout justify-start class="mb-0 pb-0 ">
                      <v-flex class="ml-4  mb-0 pb-0 mr-5" xs4>
                        <v-text-field
                          v-model="clientObj.clientInfo.phoneMain"
                          label="Phone Main"
                          :placeholder="this.db.clientInfo.phoneMain"
                          single-line
                        ></v-text-field>
                      </v-flex>
                      <v-flex class="mr-5 mb-0 pb-0 " xs4>
                        <v-text-field
                          v-model="clientObj.clientInfo.phoneSecondary"
                          label="Phone Secondary"
                          :placeholder="this.db.clientInfo.phoneSecondary"
                          single-line
                        ></v-text-field>
                      </v-flex>
                    </v-layout>
                    <v-layout class="ml-4 pt-0 mt-0" row wrap>
                      <v-flex xs8 class="mr-3">
                        <v-text-field
                          class="pt-0 mt-0"
                          v-model="clientObj.clientInfo.email"
                          label="Email"
                          :placeholder="this.db.clientInfo.email"
                          single-line
                        ></v-text-field>
                      </v-flex>
                    </v-layout>
                      ...
                      <v-list-tile>
                        <v-list-tile-content class="title">
                          <v-list-tile-title class="ml-4 mb-2 ">
                            ...
                            {{ this.db.clientInfo.phoneMain }}
                          </v-list-tile-title>
                          <v-list-tile-title class="ml-4 mb-2">
                            <v-icon color="vueblue">phone_iphone</v-icon> :
                            {{ this.db.clientInfo.phoneSecondary }}
                          </v-list-tile-title>
                          <v-list-tile-title class="ml-4">
                            <v-icon color="vueblue">email</v-icon>
                            {{ this.db.clientInfo.email }}
                          </v-list-tile-title>
                        </v-list-tile-content>
                      </v-list-tile>
                    </v-list>
            ...
            <v-layout justify-space-around="">
              <v-card color="white" width="50vw" height="70vh">
                ...
                <template v-if="edit == false">
                  <v-card-title
                    primary-title
                    class="my-0 pt-2 pb-0 mb-0 body-2"
                  >
                    sectionOne
                  </v-card-title>
