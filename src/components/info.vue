  ...
  >
    ...
    <v-card>
      <v-toolbar class="mb-4" tabs dark color="vueblue">
        ...
        <v-toolbar-title class="headline titlefix pb-0"
          >{{ myinfo.name }}
        </v-toolbar-title>
        <v-spacer></v-spacer>
        ...
        <v-tabs
          ...
          slider-color="yellow"
        >
          <v-tab ripple> {{ tabs.tabOne }} </v-tab>
          <v-tab ripple> {{ tabs.tabTwo }} </v-tab>
        </v-tabs>
      </v-toolbar>
              ...
              <v-flex xs12 sm8 lg6 xl5>
                <v-card color="white" height="370">
                  <v-card flat>
                      ...
                      <v-flex xs12>
                        <v-toolbar height="45" dark dense color="vuegreendark">
                          <v-toolbar-title>
                            ...
                            <span
                              class="ml-2 ms-fontSize-xxl ms-fontWeight-semilight	"
                            >
                              {{ sectionOne.title }}</span
                            >
                          </v-toolbar-title>

                          <v-spacer></v-spacer>
                          <v-icon
                            v-if="edit == false && editContact == false"
                            right
                            @click="edit = !edit;"
                            >edit</v-icon
                          >
                    ...
                    <template v-if="edit == true">
                      <v-layout justify-start="" class="mb-0 pb-0 ">
                        <v-flex class="ml-4 mb-0 pb-0 " xs6>
                          <v-text-field
                            v-model="clientObj.street"
                            label="Street"
                            :placeholder="this.db.street"
                            type="text"
                            single-line
                          ></v-text-field>
                        </v-flex>
                        <v-flex class="ml-5 mb-0 pb-0 " xs2>
                          <v-text-field
                            return-masked-value
                            mask="### ## ####"
                            v-model="clientObj.vafile"
                            label="VA File Number"
                            :placeholder="this.db.vafile"
                            single-line
                          ></v-text-field>
                        </v-flex>
                      </v-layout>
                      <v-layout class="ml-4 pt-0 mt-0" row wrap>
                        ...
                        <v-flex xs1 class="mr-3 pt-0 mt-0">
                          <v-text-field
                            v-model="clientObj.state"
                            label="State"
                            :placeholder="this.db.state"
                            type="text"
                            class="pt-0 mt-0"
                            single-line
                          ></v-text-field>
                        ...
                        <v-flex xs2>
                          <v-text-field
                            v-model="clientObj.zip"
                            label="Zip"
                            :placeholder="this.db.zip"
                            type="text"
                            class="pt-0 mt-0"
                            single-line
                          ></v-text-field>
                        ...
                        <v-list-tile>
                          <v-list-tile-content class="title">
                            <v-list-tile-title class="ml-4"
                              >{{ FirstName }} {{ lastName }}</v-list-tile-title
                            >
                            <v-list-tile-title class="ml-4">{{
                              this.db.street
                            }}</v-list-tile-title>
                    ...
                    <v-toolbar height="45" dark dense color="vuegreendark">
                      <v-toolbar-title>
                        <v-icon class="pb-1">person</v-icon
                        ><span
                          class="ml-2 ms-fontSize-xxl ms-fontWeight-semilight	"
                        >
                    ...
                    <template v-if="editContact == true">
                      <v-layout justify-start class="mb-0 pb-0 ">
                        <v-flex class="ml-4  mb-0 pb-0 mr-5" xs4>
                          <v-text-field
                            ...
                            mask="phone"
                            prepend-icon="phone"
                            v-model="clientObj.phoneMain"
                            label="Phone Main"
                            :placeholder="this.db.phoneMain"
                            single-line
                          ></v-text-field>
                        </v-flex>
                        <v-flex class="mr-5 mb-0 pb-0 " xs4>
                          <v-text-field
                            ...
                            v-model="clientObj.phoneSecondary"
                            label="Phone Secondary"
                            :placeholder="this.db.phoneSecondary"
                            single-line
                          ></v-text-field>
                        </v-flex>
                      </v-layout>
                      ...
                      <v-btn
                        ...
                        outline
                        round
                        @click="submitInfo(), (editContact = !editContact);"
                        color="vueblue"
                        >Save</v-btn
                      >
                      <v-btn
                        ...
                        <v-list-tile>
                          <v-list-tile-content class="title">
                            <v-list-tile-title class="ml-4 mb-2 ">
                              <v-icon color="vueblue">phone</v-icon> :
                              <span class="pl-3">{{ this.db.phoneMain }}</span>
                            </v-list-tile-title>
                            <v-list-tile-title class="ml-4 mb-2">
                              <v-icon color="vueblue">phone_iphone</v-icon> :
                              <span class="pl-3">{{
                                this.db.phoneSecondary
                              }}</span>
                            </v-list-tile-title>
                            <v-list-tile-title class="ml-4">
                              <v-icon color="vueblue">email</v-icon> :
                              <span class="pl-3">{{ this.db.email }}</span>
                            </v-list-tile-title>
                          </v-list-tile-content>
                        </v-list-tile>
                      </v-list>
                  ...
                  <v-card flat>
                    <v-toolbar height="45" dark dense color="vuegreendark">
                      <v-toolbar-title>
                        ...
                        <span class="ml-2">Disabilities</span>
                      </v-toolbar-title>
                    </v-toolbar>
                    ...
                    <v-layout justify-space-around row wrap>
                      ...
                      <v-flex text-xs-center xs3>
                        <v-card-text class="header title"> Rating </v-card-text>
                      </v-flex>
                      <v-flex text-xs-center xs3>
                        <v-card-text class="header title">
                          Remaining
