        ...
        <v-card id="card" class='mb-5'>
            <v-toolbar class='py-1' flat dense color="vuegreendark" dark>
                ...
                <v-layout justify-center>
                    <v-toolbar-title>
                        <v-chip class='elevation-1 px-2 title text-truncate' color="white" text-color="vueblue">
                            {{item.name}}
                        </v-chip>
                    </v-toolbar-title>
                </v-layout>
            ...
            <v-card-text style="text-align: justify; text-indent: 2em;" color="white" class='subheading custcard'>
                <v-textarea id="mylh" row-height="29" type="text" class="mywrapper" rows="1" auto-grow readonly solo flat color="white" v-model="formatter">
                </v-textarea>
            </v-card-text>
